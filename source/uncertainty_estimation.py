...
def main():
    ...
    parser.add_argument("--pretrain_dir", default='../saved/GBert-baseline1_seed1203', type=str, required=False,
    ...
    parser.add_argument("--do_train",
                        default=False,
                        action='store_true',
                        help="Whether to uncertainty_estimation.py training.")
    parser.add_argument("--do_eval",
                        default=True,
                        action='store_true',
                        help="Whether to uncertainty_estimation.py on the dev set.")
    parser.add_argument("--do_test",
                        default=True,
                        action='store_true',
                        help="Whether to uncertainty_estimation.py on the test set.")
    ...
    model1 = GBERT_Predict.from_pretrained(
